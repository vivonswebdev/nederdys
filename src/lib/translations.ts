const t = {
  ...
  "game.chasseurerreurs.title": { fr: "Chasseur d'Erreurs", nl: "Foutenjager" },
  "game.chasseurerreurs.desc": { fr: "Trouve le mot fautif dans la phrase !", nl: "Zoek het foute woord in de zin!" },
  "chasseurerreurs.instruction": { fr: "Écoute la phrase, puis clique sur le mot qui cloche 🔍", nl: "Luister naar de zin en klik op het woord dat fout is 🔍" },
  "game.magicienmots.title": { fr: "Le Magicien des Mots", nl: "De Woordtovenaar" },
  "game.magicienmots.desc": { fr: "Transforme le mot avec la bonne formule magique !", nl: "Tover het woord om met de juiste spreuk!" },
  "magicienmots.instruction": { fr: "Applique la transformation demandée au mot 🪄", nl: "Pas de gevraagde verandering toe op het woord 🪄" },
  "game.rouegenres.title": { fr: "Roue des Genres", nl: "Lidwoordenrad" },
  "game.rouegenres.desc": { fr: "De ou het ? Choisis le bon article !", nl: "De of het? Kies het juiste lidwoord!" },
  "rouegenres.instruction": { fr: "Écoute le mot, puis choisis « de » ou « het » 🎡", nl: "Luister naar het woord en kies « de » of « het » 🎡" },
  "game.echosons.title": { fr: "Écho des Sons", nl: "Klankecho" },
  "game.echosons.desc": { fr: "Retrouve le son caché dans le mot entendu !", nl: "Vind de klank die in het woord verstopt zit!" },
  "echosons.instruction": { fr: "Écoute bien : quel son entends-tu dans ce mot ? 🔊", nl: "Luister goed: welke klank hoor je in dit woord? 🔊" },
  "game.rouehasard.title": { fr: "La Roue du Hasard", nl: "Het Gelukswiel" },
  "game.rouehasard.desc": { fr: "La roue choisit ton calcul : trouve le résultat !", nl: "Het wiel kiest je som: vind het antwoord!" },
  "game.marathonmental.title": { fr: "Marathon Mental", nl: "Hoofdrekenmarathon" },
  "game.marathonmental.desc": { fr: "Enchaîne les calculs sans t'arrêter, le chrono court !", nl: "Reken door zonder te stoppen, de klok loopt!" },
  "game.coffrefort.title": { fr: "Le Coffre-Fort", nl: "De Brandkast" },
  "game.coffrefort.desc": { fr: "Déduis le code secret grâce aux indices !", nl: "Ontdek de geheime code met de aanwijzingen!" },
  "game.desmaths.title": { fr: "Les Dés Mathématiques", nl: "De Rekendobbelstenen" },
  "game.desmaths.desc": { fr: "Lance les dés et calcule le résultat !", nl: "Gooi de dobbelstenen en reken uit!" },
  ...
  // === JEUX FRANÇAIS (16) ===
  "game.syllabesfete.title": { fr: "Syllabes en Fête", nl: "Lettergreepfeest" },
  "game.syllabesfete.desc": { fr: "Assemble les syllabes pour former le mot !", nl: "Zet de lettergrepen samen tot een woord!" },
  "syllabesfete.instruction": { fr: "Choisis la syllabe qui complète le mot 🎉", nl: "Kies de lettergreep die het woord aanvult 🎉" },
  "game.chassesonsfr.title": { fr: "Chasse aux Sons", nl: "Klankenjacht" },
  "game.chassesonsfr.desc": { fr: "Repère le son caché dans le mot !", nl: "Zoek de klank die in het woord zit!" },
  "chassesonsfr.instruction": { fr: "Écoute bien, puis clique sur la bonne réponse 🔤", nl: "Luister goed en klik op het juiste antwoord 🔤" },
  "game.rimemalinfr.title": { fr: "Rime Malin (FR)", nl: "Slimme Rijm (FR)" },
  "game.rimemalinfr.desc": { fr: "Trouve le mot français qui rime !", nl: "Zoek het Franse woord dat rijmt!" },
  "rimemalinfr.instruction": { fr: "Écoute le mot, puis clique sur celui qui rime 🎵", nl: "Luister naar het woord en klik op het woord dat rijmt 🎵" },
  "game.desyllabesfr.title": { fr: "Dé des Syllabes (FR)", nl: "Lettergreepdobbelsteen (FR)" },
  "game.desyllabesfr.desc": { fr: "Le dé roule : complète le mot !", nl: "De dobbelsteen rolt: vul het woord aan!" },
  "desyllabesfr.instruction": { fr: "Choisis la syllabe manquante 🎲", nl: "Kies de ontbrekende lettergreep 🎲" },
  "game.jardinmots.title": { fr: "Le Jardin des Mots", nl: "De Woordentuin" },
  "game.jardinmots.desc": { fr: "Fais pousser ton vocabulaire avec des images !", nl: "Laat je woordenschat groeien met plaatjes!" },
  "jardinmots.instruction": { fr: "Regarde l'image et choisis le bon mot 🌷", nl: "Bekijk het plaatje en kies het juiste woord 🌷" },
  "game.bullessynonymes.title": { fr: "Bulles de Synonymes", nl: "Synoniembellen" },
  "game.bullessynonymes.desc": { fr: "Trouve le mot qui veut dire la même chose !", nl: "Zoek het woord met dezelfde betekenis!" },
  "bullessynonymes.instruction": { fr: "Clique sur le synonyme du mot entendu 🫧", nl: "Klik op het synoniem van het woord dat je hoort 🫧" },
  "game.bullesmotsfr.title": { fr: "Bulles de Mots", nl: "Woordbellen" },
  "game.bullesmotsfr.desc": { fr: "Associe chaque image à son mot !", nl: "Verbind elk plaatje met zijn woord!" },
  "bullesmotsfr.instruction": { fr: "Quel mot correspond à l'image ? 🎈", nl: "Welk woord hoort bij het plaatje? 🎈" },
  "game.cartetresorfr.title": { fr: "Carte au Trésor", nl: "Schatkaart" },
  "game.cartetresorfr.desc": { fr: "Résous l'énigme pour trouver le trésor !", nl: "Los het raadsel op en vind de schat!" },
  "cartetresorfr.instruction": { fr: "Lis l'énigme et devine le mot 🗺️", nl: "Lees het raadsel en raad het woord 🗺️" },
  "game.batisseurphrases.title": { fr: "Le Bâtisseur de Phrases", nl: "De Zinnenbouwer" },
  "game.batisseurphrases.desc": { fr: "Construis des phrases bien formées !", nl: "Bouw goed gevormde zinnen!" },
  "batisseurphrases.instruction": { fr: "Choisis la phrase correcte 🧱", nl: "Kies de juiste zin 🧱" },
  "game.completehistoire.title": { fr: "Complète l'Histoire", nl: "Vul het Verhaal aan" },
  "game.completehistoire.desc": { fr: "Trouve le mot qui manque dans l'histoire !", nl: "Zoek het ontbrekende woord in het verhaal!" },
  "completehistoire.instruction": { fr: "Quel mot complète bien l'histoire ? 📖", nl: "Welk woord vult het verhaal goed aan? 📖" },
  "game.dialogueeclairfr.title": { fr: "Dialogue Éclair (FR)", nl: "Bliksemdialoog (FR)" },
  "game.dialogueeclairfr.desc": { fr: "Réponds vite et bien à ton interlocuteur !", nl: "Antwoord snel en juist!" },
  "dialogueeclairfr.instruction": { fr: "Écoute la question, puis choisis la bonne réponse ⚡", nl: "Luister naar de vraag en kies het juiste antwoord ⚡" },
  "game.piegehomophones.title": { fr: "Le Piège des Homophones", nl: "De Homofoonvalstrik" },
  "game.piegehomophones.desc": { fr: "a ou à ? ou ou où ? Ne tombe pas dans le piège !", nl: "a of à? ou of où? Trap niet in de val!" },
  "piegehomophones.instruction": { fr: "Choisis la bonne orthographe 🪤", nl: "Kies de juiste spelling 🪤" },
  "game.chasseurerreursfr.title": { fr: "Chasseur d'Erreurs (FR)", nl: "Foutenjager (FR)" },
  "game.chasseurerreursfr.desc": { fr: "Repère le mot fautif dans la phrase !", nl: "Zoek het foute woord in de zin!" },
  "chasseurerreursfr.instruction": { fr: "Clique sur le mot qui cloche 🔍", nl: "Klik op het woord dat fout is 🔍" },
  "game.rouegenresfr.title": { fr: "Roue des Genres (FR)", nl: "Geslachtenrad (FR)" },
  "game.rouegenresfr.desc": { fr: "le, la ou l' ? Fais tourner la roue !", nl: "le, la of l'? Draai aan het rad!" },
  "rouegenresfr.instruction": { fr: "Choisis le bon article ou le bon accord 🎡", nl: "Kies het juiste lidwoord of de juiste vorm 🎡" },
  "game.dicteemuette.title": { fr: "Dictée Muette", nl: "Stille Dictee" },
  "game.dicteemuette.desc": { fr: "Écoute seulement, puis choisis la bonne écriture !", nl: "Luister alleen en kies de juiste spelling!" },
  "dicteemuette.instruction": { fr: "Rien n'est écrit : écoute puis choisis 🤫", nl: "Er staat niets: luister en kies 🤫" },
  "game.echosonsfr.title": { fr: "Écho des Sons (FR)", nl: "Klankecho (FR)" },
  "game.echosonsfr.desc": { fr: "Retrouve le mot qui contient le son entendu !", nl: "Zoek het woord met de klank die je hoort!" },
  "echosonsfr.instruction": { fr: "Écoute le son, puis trouve le bon mot 🔊", nl: "Luister naar de klank en zoek het juiste woord 🔊" },
