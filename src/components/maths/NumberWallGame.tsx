    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container max-w-3xl px-4 py-8">
        ...
        <section className="bg-card border border-border rounded-2xl p-5 mb-6">
          <h2 className="text-sm font-bold text-muted-foreground mb-3">Construis ton mur ici :</h2>
          <div className="flex flex-wrap gap-3 justify-center min-h-[5rem] items-center">
            ...
            {placed.length === 0 && (
              <p className="text-muted-foreground font-dyslexic text-sm">
                Clique sur les briques ci-dessous pour les placer ici
              </p>
            )}
          </div>
        </section>
        ...
        <section className="bg-card border border-border rounded-2xl p-5 mb-6">
          <h2 className="text-sm font-bold text-muted-foreground mb-3">Briques disponibles :</h2>
