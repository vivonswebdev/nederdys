    ...
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-muted-foreground text-center mb-6 text-sm">
          <BilingualInstruction k="tir.instruction" />
        </p>
        ...
        {!gameStarted ? (
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-4"><Tb k="tir.hint" /></p>
            <p className="text-sm text-muted-foreground mb-8">
              ⏱️ {timePerWord}s <Tb k="tir.perWord" />
            </p>
                ...
                challenge && (
                  ...
                  >
                    ...
                    <Button variant="outline" onClick={handleListen} className="gap-2 mb-6">
                      <Volume2 className="w-5 h-5" /> <Tb k="tir.listen" />
                    </Button>
                    ...
                    <AnimatePresence>
                      {feedback && (
                        ...
                        >
                          {feedback === "correct" ? t("tir.correct") : `$<Tb k="tir.wrong" /> "${challenge.target}"`}
                        </motion.div>
                      )}
                    </AnimatePresence>
                  </motion.div>
